...
//                    onSearch = {
//                        keyboardController?.hide() // Hide the keyboard when the Search action is triggered
//                    }
//                ),
//                modifier =  Modifier,
//
...
//                BasicTextField(
//                    value = text,
////                    onValueChange = { text = "asdf" },
//                    singleLine = true,
//                    textStyle = TextStyle(fontSize = 16.sp, color = Color.Black),
////                    keyboardActions = KeyboardActions(onSearch = {
////                        keyboardController?.hide() // Hide the keyboard when Search is pressed
////                    }),
//                    modifier = Modifier.weight(1f),
//                    imeAction = ImeAction.Search
//                )
